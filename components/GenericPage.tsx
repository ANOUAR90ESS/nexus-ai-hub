    ...
    switch (pageId) {
      case 'about':
        return {
          ...
          content: (
            <>
              <p>Welcome to Nexus AI, the premier destination for discovering and creating with the next generation of artificial intelligence.</p>
              ...
              <p>Nexus AI is built on top of the Google GenAI SDK, leveraging the latest breakthroughs in multimodal processing. Our platform demonstrates the capabilities of low-latency audio processing, high-fidelity image generation, and semantic understanding.</p>
            </>
          )
        };
      case 'careers':
        return {
          ...
          content: (
            <>
              ...
              <p className="mt-6">Send your resume and portfolio to <a href="#" className="text-indigo-400">careers@nexusai.demo</a>.</p>
            </>
          )
        };
      case 'contact':
      ...
      case 'api':
        return {
          ...
          content: (
            <>
              <p>Integrate Nexus AI capabilities directly into your applications.</p>
        ...
        return {
          ...
          content: (
            <>
              ...
              <p>At Nexus AI, we take your privacy seriously. This policy describes how we collect, use, and protect your personal information.</p>
              ...
              <h3>Your Rights</h3>
              <p>You have the right to access, correct, or delete your personal data at any time. Contact privacy@nexusai.demo for assistance.</p>
            </>
          )
        };
      case 'terms':
        return {
          ...
          content: (
            <>
              <p>By accessing or using Nexus AI, you agree to be bound by these Terms of Service.</p>
        ...
        return {
          ...
          content: (
            <>
              ...
              <p>If you discover a security vulnerability, please report it to security@nexusai.demo. We offer a bug bounty program for valid reports.</p>
            </>
          )
        };
      default:
